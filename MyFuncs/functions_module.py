...
def merge_two_lists(list1, list2):
    ...
    if len(list1) == len(list2):
        for num in range(len(list1)):
            container.append(list1[num])
            container.append(list2[num])
...
merge_two_lists(['Ade', 'Bob', 'Nofe'],
	['female', 'male', 'female'])

print('merging two lists sequentially')
merge_two_lists(['10', '20', 30], [33, '40', 'fall'])

print('merging two lists of unequal lengths')
merge_two_lists(['God', 'too', 'jor!'], ['is', 'much'])
'''
...
'''
print('comparing add_ind function to in-built enumerate function')
